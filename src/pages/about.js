    ...
    return (
       <div className = "body">
        ...
        <Col size="sm-12" className="about">
            <p><span className="slide-right-font fade-in"> About Me </span></p>
            <p className="small fade-in">Get to know me!</p>
          </Col>
          <Row className="columns">
            <div className="col fade-in about-section-font fade-margins">
        ...
        <img src={Me} id="selfie" alt="image of me" className="slide-in from-left"/>
          </Col>
         <Col size="sm-6" className="about-photo-text-align">
            <p><span className="slide-right-font slide-in from-right"> Web Developer</span></p>
